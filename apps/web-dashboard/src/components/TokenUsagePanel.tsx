    ...
    return (
      <div className="card">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Token Usage</h3>
        </div>
        <p className="text-xs text-gray-400 dark:text-gray-500">No token usage data yet</p>
      </div>
    );
  }
