---
name: token-budget-tracking-skill
description: >
  Imported from mercury-agent-skills. Use when working with "token budget", "cost optimization",
  "token tracking", "LLM costs". Triggers: "token budget", "cost optimization", "token tracking",
  "LLM costs".
metadata:
  source: mercury-agent-skills
  original-name: token-budget-tracking
---
...
In production multi-agent systems, token costs are the new infrastructure bill — and they can spiral
fast. An agent in a loop can burn through hundreds of dollars in minutes. This skill covers how to
set budgets, track consumption in real time, attribute costs to specific agents and tasks, and
...
**A single runaway agent** consuming 50K tokens per loop for 100 iterations = **$50-$150** in
minutes.
