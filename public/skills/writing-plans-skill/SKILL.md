...
description: >
  Imported from obra/superpowers. write plan, task breakdown, implementation plan, plan tasks.
metadata:
  source: superpowers
  original-name: writing-plans
---
...
`superpowers:using-git-worktrees` skill at execution time.
