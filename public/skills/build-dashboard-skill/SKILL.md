...
Use the filter and interactivity implementation patterns below for dropdown filters, date range
filters, combined filter logic, sortable tables, and chart updates.
...
<html lang="en">
  <head>
    ...
    ></script>
    <script
      src="https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns@3.0.0"
...
- For real-time dashboards, consider connecting to a BI tool instead. These dashboards are
