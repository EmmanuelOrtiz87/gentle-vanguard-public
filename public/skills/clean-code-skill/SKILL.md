...
description: >
  Imported from mercury-agent-skills. Use when working with "clean code", "code quality",
  "refactoring", "readability", "maintainability". Triggers: "clean code", "code quality",
...
5. **Applying rules blindly**: All rules have exceptions. `goto` in C error handling is fine.
   Single-letter variables in math-heavy code are fine. Context matters.
