...
name: socratic-skill
description: >
  Imported from cc-thinking-skills. socratic, questioning, critical inquiry, dialectical.
metadata:
  source: cc-thinking-skills
  original-name: thinking-socratic
---
...
The Socratic Method, developed by the ancient Greek philosopher Socrates, uses systematic
questioning to stimulate critical thinking and illuminate ideas. Rather than providing answers, it
draws out knowledge by challenging assumptions and exploring implications.
