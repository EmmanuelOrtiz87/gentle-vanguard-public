...
const KNOWN_RENAMES: Record<string, string> = {
  ...
  'session-metrics-collector.ps1': 'src/session-metrics-tracker.ts',
  'compact-start.ps1': 'src/compact-state.ts',
  'hashline.ps1': 'src/hashline.ts',
  'token-efficiency-estimator.ps1': 'src/token-optimization-orchestrator.ts',
  'maintenance-watchtower.ps1': 'src/core/maintenance-watchtower.ts',
  'health-check.ps1': 'src/core/health-check.ts',
  'session-autostart.ps1': 'src/session-autostart.ts',
  'knowledge-base-autoinit.ps1': 'src/knowledge-base-manager.ts',
  'usage-tracker.ps1': 'src/skills/skill-usage-tracker.ts',
  'sync-agent-instructions.ps1': 'src/skills/skill-usage-tracker.ts',
  'context-pack.ps1': 'src/compact-state.ts',
  'context-metrics-report.ps1': 'src/session-metrics-tracker.ts',
  'codegraph-semantic-search.ps1': 'src/codegraph-mcp-server-start.ts',
  'codegraph-enrich.ps1': 'src/codegraph-post-modification-sync.ts',
  'distributed-tracing-core.ps1': 'src/tracing-instrument.ts',
  'otel-exporter.ps1': 'src/tracing-instrument.ts',
  'metrics-collector.ps1': 'src/session-metrics-tracker.ts',
  'telemetry-dashboard.ps1': 'src/dashboard-ws-autostart.ts',
  'auto-delegation-router.ps1': 'src/agent-delegator.ts',
  'audit-sweep.ps1': 'src/infrastructure/audit-pipeline.ts',
  'sync-local.ps1': 'src/infrastructure/audit-pipeline.ts',
  'invoke-document-analysis.ps1': 'src/document-analysis-init.ts',
  'document-analysis-init.ps1': 'src/document-analysis-init.ts',
  'token-usage-auto.ps1': 'src/token-usage-auto.ts',
  'invoke-cloud-agent.ps1': 'src/hybrid-executor.ts',
  'analyze.ps1': 'src/hybrid-executor.ts',
  'invoke-ai-review.ps1': 'src/auto-code-review.ts',
  'judgment-day-orchestrator.ps1': 'src/learning-engine.ts',
  'failure-learning-system.ps1': 'src/learning-engine.ts',
  'session-learning-capture.ps1': 'src/learning-engine.ts',
  'gentle-vanguard-sync.ps1': 'src/engram-auto-sync.ts',
