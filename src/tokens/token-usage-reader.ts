 ...
 * src/tokens/token-ingest.ts which reads each tool's own persisted session data) and
 ...
 *
 * Usage:
 *   npx tsx src/tokens/token-usage-reader.ts            # human-readable
 *   npx tsx src/tokens/token-usage-reader.ts --json     # machine-readable
 */
